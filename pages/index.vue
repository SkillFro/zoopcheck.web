<template>
  ...
  <section class="max-w-[85rem] mt-30 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <section class="">
      <div class="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="text-center">
          <p class="inline-flex px-4 py-2 text-sm text-gray-900 border border-gray-200 rounded-full font-pj">Made by
            Developers, for Developers</p>
          <h1
            class="mt-5 text-4xl font-bold leading-tight text-gray-900 sm:text-5xl sm:leading-tight lg:text-6xl lg:leading-tight">
            Quality resources shared by the community</h1>
          <p class=" mt-6 text-base leading-7 text-gray-600 font-inter">Lorem ipsum dolor sit amet, consectetur
            adipiscing elit. Vehicula massa in enim luctus. Rutrum arcu.</p>
          ...
          <div class="relative inline-flex mt-10 group">
            ...
            <a href="#" title=""
              class="relative inline-flex items-center justify-center md:px-8 md:py-4 py-2 px-4 text-lg font-semibold text-white transition-all duration-200 bg-gray-900 font-pj rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
              role="button">
      ...
      <div class="mt-16 md:mt-20 overflow-hidden">
        <img class="object-cover object-top scale-150 2xl:max-w-screen-2xl xl:scale-100 w-full h-auto mx-auto "
  ...
  <section>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="w-2/3 sm:w-1/2 lg:w-1/3 mx-auto text-center mb-6">
        <h2 class="text-gray-600 ">Trusted by Open Source, enterprise, and more than 99,000 of you
        </h2>
      </div>
      ...
      <div class="grid grid-cols-3 md:grid-cols-6 gap-x-6">
        ...
        <svg class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 mx-auto text-gray-500 " xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="grid grid-cols-3 md:grid-cols-5 gap-x-6 sm:gap-x-6">
        ...
        <svg class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 mx-auto text-gray-500 " height="728" viewBox="0 0 512 149"
  ...
  <section class="mt-10">
    <div class="">
      <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <h2 class="text-center text-base/7 font-semibold text-[#086BD8]">Deploy faster</h2>
        <p
          ...
          <div class="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            ...
            <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
              <div class="px-8 pt-8 sm:px-10 sm:pt-10">
                ...
                <p class="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">Morbi viverra dui mi arcu sed.
  ...
  <section>
    ...
    <div class="max-w-[85rem] px-4 mt-10 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center lg:justify-between">
        ...
        <div class="mt-10 lg:mt-0 lg:col-span-6 lg:col-end-13">
          <div class="space-y-6 sm:space-y-8">
            ...
            <ul class="grid grid-cols-2  divide-gray-200 overflow-hidden ">
              ...
              <li class="flex flex-col -m-0.5 p-4 sm:p-8">
                <div class="flex items-end gap-x-2 text-3xl sm:text-5xl font-bold text-gray-800 mb-2 ">
                  <svg class="shrink-0 size-5 text-[#086BD8] " width="24" height="24" viewBox="0 0 24 24" fill="none"
  ...
  <section>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
        <h2 class="text-2xl font-bold md:text-4xl md:leading-tight ">The case studies</h2>
      ...
      <div class="mt-12 text-center">
        <a class="py-3 px-4 inline-flex items-center gap-x-1 text-sm font-medium rounded-full border border-gray-200 bg-white text-[#086BD8] shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none "
          href="/blogs">
          Read more
  ...
  <section class="bg-white text-center border-y border-gray-200">
    <div class="max-w-3xl mx-auto px-6 py-10">
      <h1 class="text-slate-900 text-4xl sm:text-5xl font-semibold leading-tight">
        Boost your productivity.<br />
        Start using our app today.
      </h1>
      <p class="mt-4 text-gray-600 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
      ...
      <div class="mt-8 flex justify-center items-center space-x-4">
        <button
          class="bg-indigo-600 text-white font-semibold text-sm px-5 py-2.5 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
          Get started
        </button>
        <a href="#" class="text-gray-900 font-semibold text-sm flex items-center space-x-1 hover:underline">
    ...
    <div class="max-w-[85rem] mt-10 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="grid md:grid-cols-5 gap-10">
        <div class="md:col-span-2">
          <div class="max-w-xs">
            <h2 class="text-2xl font-bold md:text-4xl md:leading-tight ">Frequently<br>asked questions
            </h2>
            <p class="mt-1 hidden md:block text-gray-600 ">Answers to the most frequently asked
              questions.</p>
          </div>
        </div>

        <div class="md:col-span-3">
          <div v-for="(faq, index) in faqs" class="hs-accordion-group mt-5  divide-y divide-gray-200 ">
            <div class="hs-accordion pb-3 active" id="hs-basic-with-title-and-arrow-stretched-heading-one">
              <button @click="toggle(index)"
                class="hs-accordion-toggle group pb-3 cursor-pointer inline-flex items-center justify-between gap-x-3 w-full md:text-lg font-semibold text-start text-gray-800 rounded-lg transition hover:text-gray-500 focus:outline-hidden focus:text-gray- "
              ...
              <div v-if="openIndex === index" id="hs-basic-with-title-and-arrow-stretched-collapse-one"
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Once your team signs up for a subscription plan, we sit down, grab a cup of coffee, and dial in the details.',
  },
  {
    question: 'Is there a free trial available?',
    answer:
      'Yes! You can try our service free for 14 days with no credit card required.',
  },
  {
    question: 'Can I cancel at anytime?',
    answer:
