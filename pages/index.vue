<template>
  <section
    class="max-w-[85rem] mt-30 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto"
  >
    <section class="">
      <div class="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="text-center">
          <p
            class="inline-flex px-4 py-2 text-sm text-gray-900 border border-gray-200 rounded-full font-pj"
          >
          ...
          <p class="mt-6 text-base leading-7 text-gray-600 font-inter">
      ...
      <div class="mt-16 md:mt-20 overflow-hidden">
        <img
          class="object-cover object-top scale-150 2xl:max-w-screen-2xl xl:scale-100 w-full h-auto mx-auto"
  ...
  <section class="mt-10">
    <div class="">
      <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <h2 class="text-center text-base/7 font-semibold text-[#086BD8]">
          Deploy faster
        </h2>
        <p
  ...
  <section>
    <div
      class="max-w-[85rem] px-4 mt-10 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto"
    >
      <div
          ...
          <div class="space-y-6 sm:space-y-8">
            <ul class="grid grid-cols-2 divide-gray-200 overflow-hidden">
              ...
              <li class="flex flex-col -m-0.5 p-4 sm:p-8">
                ...
                >
                  <svg
                    class="shrink-0 size-5 text-[#086BD8]"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                    fill="none"
  ...
  <section
    class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto"
  >
    <TechBlog
      v-for="(blog, title) in blogs"
      :key="title"
      :blog="blog"
      :href="`/blogs/${blog.title.toLowerCase().replaceAll(' ', '-')}`"
    />
  </section>
  <div class="mb-12 text-center">
    <a
      class="py-3 px-4 inline-flex items-center gap-x-1 text-sm font-medium rounded-full border border-gray-200 bg-white text-[#086BD8] shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
      href="/blogs"
    >
      Read more
      <svg
  ...
  <section class="bg-white text-center border-y border-gray-200">
    <div class="max-w-3xl mx-auto px-6 py-10">
      <h1
        class="text-slate-900 text-4xl sm:text-5xl font-semibold leading-tight"
      >
        Boost your productivity.<br />
        Start using our app today.
      </h1>
      <p
        class="mt-4 text-gray-600 text-base sm:text-lg max-w-xl mx-auto leading-relaxed"
      >
      ...
      <div class="mt-8 flex justify-center items-center space-x-4">
        ...
        <a
          href="#"
          class="text-gray-900 font-semibold text-sm flex items-center space-x-1 hover:underline"
        >
  ...
  <section>
    <div
      class="max-w-[85rem] mt-10 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto"
    >
      <div class="grid md:grid-cols-5 gap-10">
        ...
        <div class="md:col-span-3">
          <div
            ...
            :key="index"
            class="hs-accordion-group mt-5 divide-y divide-gray-200"
          >
            <div
            ...
            >
              ...
              >
                ...
                <svg
                  class="hs-accordion-active:block hidden shrink-0 size-5 text-gray-600 group-hover:text-gray-500"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
...
const blogs = [
  ...
  },
  {
    ...
    description:
      "The BackstorySanjay Patel (name changed) a former bank manager with 20 years in finance, felt stuck. After his bank automated most processes he faced a choice: retrain or risk obsolescence.",
